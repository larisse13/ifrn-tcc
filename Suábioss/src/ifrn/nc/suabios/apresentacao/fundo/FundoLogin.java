...
public class FundoLogin extends javax.swing.JPanel{
	...
	b = ImageIO.read(getClass().getResourceAsStream("login.jpg"));
	...
	/*
	* Se você quiser que a imagem seja uma só (extendida ao tamanho da tela, não replic
	ada
